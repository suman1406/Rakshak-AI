...
Additional final browser coverage: all 12 public, legal, authentication and application routes fit 320px with the enlarged type. Organization settings usage rows stack at narrow widths, and workspace-to-settings navigation resets correctly at 1440/390/320px. The refreshed Android debug package built successfully.
