...
import { ArrowDownToLine, ArrowUpRight, ChevronRight, CircleHelp, FolderOpen, Plus, RefreshCw, Search, SlidersHorizontal, Sprout } from 'lucide-react';
...
export const OrgDashboard: React.FC = () => {
    ...
    <header className="workspace-heading"><div><span className="page-context">Your organization at a glance</span><h1>Field overview</h1><p>A shared view of your fields and their latest observations.</p></div><Link className="action" to="/organization/scans"><Plus size={16}/>Add field evidence</Link></header>
