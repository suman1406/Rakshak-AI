...
class _ScanHistoryScreenState extends State<ScanHistoryScreen> {
  ...
  void initState() {
    super.initState();
    scans = ApiClient.instance.listVideos();
  }
  ...
  Widget build(BuildContext context) => FutureBuilder<
      ...
      future: scans,
      builder: (context, snapshot) => PageContent(children: [
            Text('Scan history',
            ...
            if (snapshot.hasError)
              const AppCard(
                  child:
                      Text('Could not load scan history. Please try again.')),
            SecondaryAction(
                label: 'Refresh history',
                onPressed: () =>
                    setState(() => scans = ApiClient.instance.listVideos())),
                  ...
                  child: InkWell(
                      onTap: () => navigateTo(
                          ...
                          AnalyzingCropHealthScreen(
                              videoId: scan['video_id'].toString())),
                      child: AppCard(
                          child: Row(children: [
                        ...
                        Expanded(
                            child: Column(
                              ...
                              Text(scan['status']?.toString() == 'failed'
                                  ? 'This scan could not be completed. Open it for next steps.'
